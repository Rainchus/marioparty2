...
void func_80102950_36DAF0(omObjData* arg0);
void func_80102A6C_36DC0C(void);
void func_80102AD8_36DC78(void);
...
extern s32 D_80102D54_36DEF4;
extern u16 D_8010163C_10223C;

//TODO: this gets put into .scommon instead of .bss
//bss
extern Process* D_80102D60_36DF00;

void func_80102830_36D9D0(void) {
    func_80020070_20C70(1);
    omInitObjMan(16, 4);
    D_80102708_103308 = 1;
    if (D_80102D50_36DEF0 == 0) {
        func_80068410_69010();
        D_80102D60_36DF00 = omAddPrcObj(func_80102AD8_36DC78, 0xA, 0, 0);
        omAddObj(1000, 0, 0, -1, func_80102950_36DAF0);
    } else {
        D_80102D60_36DF00 = omAddPrcObj(func_80102AD8_36DC78, 0xA, 0, 0);
        omAddObj(1000, 0, 0, -1, func_80102950_36DAF0);
        omAddObj(10, 0, 0, -1, func_80102A6C_36DC0C);
    }
}

void func_8010290C_36DAAC(void) {
    D_80102D50_36DEF0 = 0;
    func_80102830_36D9D0();
}
...
void func_80102950_36DAF0(omObjData* arg0) {
    if (((D_801011FC_101DFC != 0) || (D_80102D54_36DEF4 != 0)) && (func_8008F618_90218() == 0)) {
        func_8008F624_90224(0, 0, 0);
        InitFadeOut(0, 9);
        arg0->func_ptr = &func_80102A04_36DBA4;
