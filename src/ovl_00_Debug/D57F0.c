...
INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80102D54_D5D44);
...
INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80103C4C_D6C3C);

INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80103E50_D6E40);

INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80104ADC_D7ACC);

INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80104FA4_D7F94);
...
INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80105B5C_D8B4C);

INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80105BDC_D8BCC);

INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80105C50_D8C40);

INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80105CC0_D8CB0);

INCLUDE_ASM(const s32, "ovl_00_Debug/D57F0", func_80105D9C_D8D8C);
